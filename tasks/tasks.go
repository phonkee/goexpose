...
*/
func ShellTaskFactory(server goexpose.Server, taskconfig *domain.TaskConfig, ec *domain.EndpointConfig) (tasks []domain.Tasker, err error) {
...
*/
func InfoTaskFactory(server goexpose.Server, taskconfig *domain.TaskConfig, ec *domain.EndpointConfig) (tasks []domain.Tasker, err error) {
...
*/
func HttpTaskFactory(server goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (tasks []domain.Tasker, err error) {
	// default config
...
*/
func (h *HttpTask) Run(r *http.Request, data map[string]interface{}) (response domain.Response) {
...
func PostgresTaskFactory(server goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (tasks []domain.Tasker, err error) {
	...
	tasks = []domain.Tasker{&PostgresTask{
		config: config,
	}}
...
*/
func RedisTaskFactory(server goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (result []domain.Tasker, err error) {
...
func CassandraTaskFactory(s goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (result []domain.Tasker, err error) {
	...
	result = []domain.Tasker{&CassandraTask{
		config: config,
	}}
	return
}
...
Run cassandra task
*/
func (c *CassandraTask) Run(r *http.Request, data map[string]interface{}) (response domain.Response) {
...
*/
func MySQLTaskFactory(s goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (result []domain.Tasker, err error) {
	config := &MySQLTaskConfig{}
	if err = json.Unmarshal(tc.Config, config); err != nil {
		return
	}

	result = []domain.Tasker{&MySQLTask{
		config: config,
	}}
	return
}
...
Run mysql task.
*/
func (m *MySQLTask) Run(r *http.Request, data map[string]interface{}) (response domain.Response) {
...
Factory to create task
*/
func MultiTaskFactory(s goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (result []domain.Tasker, err error) {
...
*/
func (f *FilesystemTask) Run(r *http.Request, data map[string]interface{}) (response *goexpose.Response) {
...
*/
func FilesystemFactory(s goexpose.Server, tc *domain.TaskConfig, ec *domain.EndpointConfig) (result []domain.Tasker, err error) {
	...
	result = []domain.Tasker{&FilesystemTask{
		config: config,
	}}
	return
}
